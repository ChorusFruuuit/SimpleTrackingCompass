...
public final class SimpleTrackingCompassClient {
    public static final ResourceLocation COMPASS_STATIC = Utils.identifierWithModNamespace("textures/hud/compass_static.png");
    public static final ResourceLocation ARROW_UP = Utils.identifierWithModNamespace("textures/hud/arrow_up.png");
    public static final ResourceLocation ARROW_DOWN = Utils.identifierWithModNamespace("textures/hud/arrow_down.png");

    public static final ResourceLocation FILTER = Utils.identifierWithModNamespace("textures/gui/filter.png");
    public static final ResourceLocation REFRESH = Utils.identifierWithModNamespace("textures/gui/refresh.png");
