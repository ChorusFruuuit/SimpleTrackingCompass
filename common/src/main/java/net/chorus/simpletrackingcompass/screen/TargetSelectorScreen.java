...
public class TargetSelectorScreen extends Screen implements PacketDestination {
    ...
    protected void init() {
        ...
        OptionsScreen optionsScreen = new OptionsScreen(this, client().options, PlayerUtils.inWorld());
        ...
        Button doneButton = Button
            .builder(doneButtonMessage, _ -> onClose())
        ...
        CycleButton<Boolean> toggleButton = CycleButton
            ...
            .create(
                ...
                (_, value) -> CompassTracker.setCompassHidden(value));
